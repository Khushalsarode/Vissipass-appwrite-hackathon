...
const VisitorPassForm = () => {
    ...
    const initialValues = {
        ...
        termsAndConditions: false, // Make sure to add this field back for validation
    };
    ...
    const validationSchema = Yup.object({
        ...
        termsAndConditions: Yup.boolean().oneOf([true], 'You must accept the terms and conditions'), // Validation for terms and conditions
    });
    ...
    const handleSubmit = async (values) => {
        try {
            ...
            // Prepare data for submission without terms and conditions
            const { termsAndConditions, ...dataToSubmit } = values; // Destructure to exclude termsAndConditions
